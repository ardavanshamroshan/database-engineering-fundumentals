import{_ as n,o as e,c as p,j as s,a2 as i}from"./chunks/framework.DCFw80wP.js";const u=JSON.parse('{"title":"Redis","description":"","frontmatter":{"title":"Redis","outline":"deep"},"headers":[],"relativePath":"nosql/redis.md","filePath":"nosql/redis.md","lastUpdated":null}'),l={name:"nosql/redis.md"};function t(c,a,o,d,r,h){return e(),p("div",null,[...a[0]||(a[0]=[s("div",{class:"db-hero"},[s("span",{class:"db-logo db-logo--redis",role:"img","aria-label":"Redis logo"}),s("div",null,[s("h1",null,"Redis"),s("p",{class:"db-hero__blurb"},"cache · structures · streams")])],-1),i(`<p><strong>Author:</strong> Ardavan ShamRoshan<br><strong>Scope:</strong> Practical day-to-day reference (<code>redis-cli</code>, data types, keys, persistence, ops).<br><strong>Audience:</strong> Engineers who need Redis commands fast (cache, sessions, queues, counters).<br><strong>Notes:</strong> Examples target Redis 6+/7+. ACL &amp; some commands differ on Redis Cluster / managed Redis (ElastiCache, Memorystore, Upstash).</p><hr><h2 id="table-of-contents" tabindex="-1">Table of contents <a class="header-anchor" href="#table-of-contents" aria-label="Permalink to &quot;Table of contents&quot;">​</a></h2><ol><li><a href="#_1-connect-flags">Connect &amp; flags</a></li><li><a href="#_2-redis-cli-essentials">redis-cli essentials</a></li><li><a href="#_3-keys-generic-commands">Keys &amp; generic commands</a></li><li><a href="#_4-strings">Strings</a></li><li><a href="#_5-hashes">Hashes</a></li><li><a href="#_6-lists">Lists</a></li><li><a href="#_7-sets">Sets</a></li><li><a href="#_8-sorted-sets-zset">Sorted sets (ZSET)</a></li><li><a href="#_9-streams">Streams</a></li><li><a href="#_10-pubsub">Pub/Sub</a></li><li><a href="#_11-expiry-ttl-memory">Expiry, TTL &amp; memory</a></li><li><a href="#_12-transactions-lua-pipelines">Transactions, Lua &amp; pipelines</a></li><li><a href="#_13-users-acl-security">Users, ACL &amp; security</a></li><li><a href="#_14-persistence-backup-replication">Persistence, backup &amp; replication</a></li><li><a href="#_15-info-slowlog-useful-ops">Info, slowlog &amp; useful ops</a></li><li><a href="#_16-tools-resources">Tools &amp; resources</a></li></ol><p>Placeholders use <code>__name__</code> style. Replace them before running.</p><hr><h2 id="_1-connect-flags" tabindex="-1">1. Connect &amp; flags <a class="header-anchor" href="#_1-connect-flags" aria-label="Permalink to &quot;1. Connect &amp; flags&quot;">​</a></h2><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-dark github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># Local default (6379)</span></span>
