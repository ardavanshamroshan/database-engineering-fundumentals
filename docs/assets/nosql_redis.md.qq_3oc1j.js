import{_ as a,o as n,c as e,a2 as p}from"./chunks/framework.DCFw80wP.js";const k=JSON.parse('{"title":"Redis","description":"","frontmatter":{"title":"Redis","outline":"deep"},"headers":[],"relativePath":"nosql/redis.md","filePath":"nosql/redis.md","lastUpdated":null}'),i={name:"nosql/redis.md"};function l(t,s,c,o,d,r){return n(),e("div",null,[...s[0]||(s[0]=[p(`<h1 id="redis" tabindex="-1">Redis <a class="header-anchor" href="#redis" aria-label="Permalink to &quot;Redis&quot;">​</a></h1><p><strong>Author:</strong> Ardavan ShamRoshan<br><strong>Scope:</strong> Practical day-to-day reference (<code>redis-cli</code>, data types, keys, persistence, ops).<br><strong>Audience:</strong> Engineers who need Redis commands fast (cache, sessions, queues, counters).<br><strong>Notes:</strong> Examples target Redis 6+/7+. ACL &amp; some commands differ on Redis Cluster / managed Redis (ElastiCache, Memorystore, Upstash).</p><hr><h2 id="table-of-contents" tabindex="-1">Table of contents <a class="header-anchor" href="#table-of-contents" aria-label="Permalink to &quot;Table of contents&quot;">​</a></h2><ol><li><a href="#1-connect--flags">Connect &amp; flags</a></li><li><a href="#2-redis-cli-essentials">redis-cli essentials</a></li><li><a href="#3-keys--generic-commands">Keys &amp; generic commands</a></li><li><a href="#4-strings">Strings</a></li><li><a href="#5-hashes">Hashes</a></li><li><a href="#6-lists">Lists</a></li><li><a href="#7-sets">Sets</a></li><li><a href="#8-sorted-sets-zset">Sorted sets (ZSET)</a></li><li><a href="#9-streams">Streams</a></li><li><a href="#10-pubsub">Pub/Sub</a></li><li><a href="#11-expiry-ttl--memory">Expiry, TTL &amp; memory</a></li><li><a href="#12-transactions-lua--pipelines">Transactions, Lua &amp; pipelines</a></li><li><a href="#13-users-acl--security">Users, ACL &amp; security</a></li><li><a href="#14-persistence-backup--replication">Persistence, backup &amp; replication</a></li><li><a href="#15-info-slowlog--useful-ops">Info, slowlog &amp; useful ops</a></li><li><a href="#16-tools--resources">Tools &amp; resources</a></li></ol><p>Placeholders use <code>__name__</code> style. Replace them before running.</p><hr><h2 id="_1-connect-flags" tabindex="-1">1. Connect &amp; flags <a class="header-anchor" href="#_1-connect-flags" aria-label="Permalink to &quot;1. Connect &amp; flags&quot;">​</a></h2><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># Local default (6379)</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">redis-cli</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -h</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> __host__</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -p</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 6379</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -a</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;__password__&#39;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -n</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 0</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># URI</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">redis-cli</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -u</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> redis://:__password__@__host__:6379/0</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">redis-cli</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -u</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> rediss://:__password__@__host__:6380/0</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">   # TLS</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">redis-cli</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> SET</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> greeting</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> hello</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">redis-cli</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> GET</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> greeting</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># Read from file / stdin</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">redis-cli</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> &lt;</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> script.txt</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">redis-cli</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> --pipe</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> &lt;</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> bulk.txt</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># Scan-friendly / big output</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">redis-cli</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> --scan</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> --pattern</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;user:*&#39;</span></span>
...
<span class="line"><span>UNWATCH</span></span></code></pre></div><p>Not rollback-on-error like SQL; commands queue then run sequentially.</p><h3 id="pipeline-client-side" tabindex="-1">Pipeline (client-side) <a class="header-anchor" href="#pipeline-client-side" aria-label="Permalink to &quot;Pipeline (client-side)&quot;">​</a></h3><p>Batch many commands, cut RTT. In <code>redis-cli</code>:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">redis-cli</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> --pipe</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> &lt;</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> commands.txt</span></span></code></pre></div><h3 id="lua-scripts-atomic-server-side" tabindex="-1">Lua scripts (atomic server-side) <a class="header-anchor" href="#lua-scripts-atomic-server-side" aria-label="Permalink to &quot;Lua scripts (atomic server-side)&quot;">​</a></h3><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>EVAL &quot;return redis.call(&#39;GET&#39;, KEYS[1])&quot; 1 mykey</span></span>
...
<span class="line"><span>CONFIG GET appendfsync     # always | everysec | no</span></span></code></pre></div><p>Typical prod: <strong>AOF everysec</strong> and/or RDB snapshots. Managed Redis often handles this for you.</p><h3 id="copy-files-cold" tabindex="-1">Copy files (cold) <a class="header-anchor" href="#copy-files-cold" aria-label="Permalink to &quot;Copy files (cold)&quot;">​</a></h3><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># Stop writes / use BGSAVE then copy dump.rdb / appendonly.aof</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">cp</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> /var/lib/redis/dump.rdb</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> backup/</span></span></code></pre></div><h3 id="replication" tabindex="-1">Replication <a class="header-anchor" href="#replication" aria-label="Permalink to &quot;Replication&quot;">​</a></h3><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>INFO replication</span></span>
<span class="line"><span>ROLE</span></span>
<span class="line"><span>REPLICAOF __host__ __port__    # (SLAVEOF legacy alias)</span></span>
<span class="line"><span>REPLICAOF NO ONE               # promote</span></span></code></pre></div><h3 id="cluster-high-level" tabindex="-1">Cluster (high level) <a class="header-anchor" href="#cluster-high-level" aria-label="Permalink to &quot;Cluster (high level)&quot;">​</a></h3><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">redis-cli</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -c</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -h</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> __host__</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">CLUSTER</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> KEYSLOT</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> __key__</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">CLUSTER</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> SLOTS</span></span></code></pre></div><h3 id="flush-danger" tabindex="-1">Flush (danger) <a class="header-anchor" href="#flush-danger" aria-label="Permalink to &quot;Flush (danger)&quot;">​</a></h3><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>FLUSHDB                  # current DB</span></span>
<span class="line"><span>FLUSHDB ASYNC</span></span>
<span class="line"><span>FLUSHALL                 # all DBs — catastrophic</span></span>
<span class="line"><span>FLUSHALL ASYNC</span></span></code></pre></div><hr><h2 id="_15-info-slowlog-useful-ops" tabindex="-1">15. Info, slowlog &amp; useful ops <a class="header-anchor" href="#_15-info-slowlog-useful-ops" aria-label="Permalink to &quot;15. Info, slowlog &amp; useful ops&quot;">​</a></h2><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>INFO</span></span>
...
<span class="line"><span>cache:page:{slug}         # string with TTL</span></span></code></pre></div><hr><p><em>Compiled for personal study use. Prefer SCAN, TTLs, and ACL in production. Confirm command availability for your Redis major version and hosting platform.</em></p>`,127)])])}const u=a(i,[["render",l]]);export{k as __pageData,u as default};
